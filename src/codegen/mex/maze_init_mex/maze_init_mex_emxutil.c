 ...
 *
 * maze_init_mex_emxutil.c
 *
 * Code generation for function 'maze_init_mex_emxutil'
 *
 */
...
void c_emxFreeStruct_coder_internal_(coder_internal_ref_3 *pStruct)
{
  emxFree_uint16_T(&pStruct->contents);
}

void c_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_3 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_uint16_T(sp, &pStruct->contents, 1, srcLocation, doPush);
}
...
/* End of code generation (maze_init_mex_emxutil.c) */
