 ...
 *
 * maze_init_mex_data.h
 *
 * Code generation for function 'maze_init_mex_data'
 *
 */

#ifndef MAZE_INIT_MEX_DATA_H
#define MAZE_INIT_MEX_DATA_H
...
extern int16_T wall_sensor_front_th;
extern int16_T wall_sensor_right_th;
extern int16_T wall_sensor_left_th;
extern uint32_T matrix_dir_dirty;
extern uint32_T g_direction_dirty;
extern uint32_T g_d_direction_dirty;
extern uint32_T l_direction_dirty;
extern uint32_T move_dir_property_dirty;
extern uint32_T turn_pattern_dirty;
extern uint32_T wall_sensor_front_th_dirty;
extern uint32_T wall_sensor_right_th_dirty;
extern uint32_T wall_sensor_left_th_dirty;
...
/* End of code generation (maze_init_mex_data.h) */
