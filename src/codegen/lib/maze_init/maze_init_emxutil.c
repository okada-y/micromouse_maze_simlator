...
/*
 * Arguments    : coder_internal_ref_3 *pStruct
 * Return Type  : void
 */
 ...
 * Return Type  : void
 */
void c_emxInitStruct_coder_internal_(coder_internal_ref_3 *pStruct)
{
  emxInit_uint16_T(&pStruct->contents, 1);
}
...
/*
 * File trailer for maze_init_emxutil.c
 *
 * [EOF]
 */
